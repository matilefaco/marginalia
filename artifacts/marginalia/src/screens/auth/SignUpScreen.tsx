    ...
    <>
      ...
      >
        ...
        <div className="mb-8">
          ...
          <h2 className="font-serif italic text-[28px] text-[#1E1C19] leading-tight mb-1">
            Criar conta
          </h2>
          <p className="font-sans font-light text-[11px] text-[#7A726A]">
        ...
        <div className="flex-1 space-y-5 overflow-auto pb-2">
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="font-sans text-[11px] font-light tracking-[0.12em] uppercase text-[#4A4540] block mb-1.5">
                Nome
              </label>
              <input
                ...
                className="w-full font-serif italic text-[16px] text-[#1E1C19] placeholder:text-[#9C948C] bg-transparent border-b border-[#4A4540]/20 pb-2 outline-none focus:border-[#697962]/70 transition-colors"
              />
            </div>
            <div>
              <label className="font-sans text-[11px] font-light tracking-[0.12em] uppercase text-[#4A4540] block mb-1.5">
          ...
          <div>
            <label className="font-sans text-[11px] font-light tracking-[0.12em] uppercase text-[#4A4540] block mb-1.5">
              Bio{" "}
              <span className="text-[#9C948C] normal-case tracking-normal">
                · opcional
              </span>
            </label>
            <textarea
              ...
              rows={2}
              className="w-full font-serif italic text-[15px] text-[#1E1C19] placeholder:text-[#9C948C] bg-transparent border-b border-[#4A4540]/20 pb-2 outline-none focus:border-[#697962]/70 transition-colors resize-none"
            />
          </div>

          <div className="pt-1">
            <div className="w-full h-[1px] bg-[#EBE6DB] mb-4" />
            <p className="font-sans text-[11px] font-light tracking-[0.12em] uppercase text-[#4A4540] mb-3">
              Avatar
            </p>
          ...
          {externalError && (
            <p className="font-sans text-[13px] text-red-600 text-center">
              {externalError}
            </p>
          )}
        </div>
        ...
        <div className="pt-5">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 text-[#FAF8F3] font-sans font-light text-[13px] tracking-[0.14em] uppercase disabled:opacity-30 active:scale-[0.99] transition-all"
